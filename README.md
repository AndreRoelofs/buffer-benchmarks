...
- Protobuf (rust-protobuf): [stepancheg/rust-protobuf](https://github.com/stepancheg/rust-protobuf) 3.7.2
- Protobuf (prost): [tokio-rs/prost](https://github.com/tokio-rs/prost) 0.14.1
- FlatBuffers: [google/flatbuffers](https://github.com/google/flatbuffers/tree/master/rust) 25.9.23
- Capnp: [capnproto/capnproto-rust](https://github.com/capnproto/capnproto-rust) 0.23.0

| Test                     | Protobuf (rust-protobuf) | Protobuf (prost) | FlatBuffers | Capnp  | Capnp (packed) |
| ------------------------ | ------------------------ | ---------------- | ----------- | ------ | -------------- |
| Encode (ns/op)           | 179.90                   | 142.04           | 298.71      | 200.22 | 293.29         |
| Decode (ns/op)           | 233.11                   | 264.20           | 157.91      | 126.41 | 185.45         |
| Wire format size (bytes) | 299                      | 299              | 428         | 440    | 193            |
