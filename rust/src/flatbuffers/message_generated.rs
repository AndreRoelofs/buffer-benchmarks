...
pub mod farcaster {
    ...
    impl flatbuffers::Verifiable for SignatureScheme {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
    ...
    impl flatbuffers::Verifiable for HashScheme {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
    ...
    impl flatbuffers::Verifiable for FarcasterNetwork {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
    ...
    impl flatbuffers::Verifiable for ReactionType {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
    ...
    impl flatbuffers::Verifiable for UserDataType {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
    ...
    impl flatbuffers::Verifiable for TargetId {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
    ...
    impl flatbuffers::Verifiable for MessageBody {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
    ...
    impl Default for ReactionBodyArgs {
        #[inline]
        fn default() -> Self {
            ReactionBodyArgs {
    ...
    pub fn root_as_message(buf: &'_ [u8]) -> Result<Message<'_>, flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn root_as_message_unchecked(buf: &'_ [u8]) -> Message<'_> {
    ...
    pub unsafe fn size_prefixed_root_as_message_unchecked(buf: &'_ [u8]) -> Message<'_> {
    ...
    #[inline]
    pub fn fjnish_size_prefixed_message_buffer<'a>(
        fbb: &mut flatbuffers::FlatBufferBuilder<'a>,
        root: flatbuffers::WIPOffset<Message<'a>>,
    ) {
